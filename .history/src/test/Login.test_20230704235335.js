...
import { axiosInstanceMyStore } from '../shared/Services/Instance';
jest.mock('axios',() => {
...
describe('<Login />', () => {
    ...
    beforeEach(() => {
        axiosMock.post.mockImplementationOnce(async()=> Promise.resolve(
            {
                status : 200, message: "OK", data : {user: { name : 'Daniel', email: 'daniel@gmail.com' }, token: 'wedqewqe45ss' },
            }
        ));
